...
push_out_force_strength = 1.52
neuron_spring_constant_marginal = 2         # spring between neighbouring vertices
neuron_spring_constant_boundary = 2         # spring between boundary vertices (vertices with 3 neighbours)
neuron_spring_constant_internal = 2         # spring between opposite vertices of the same cell
